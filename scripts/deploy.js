...
const main = async () => {
    ...
    // DEPLOYMENT AND INITIAL TOKEN MINT
    ...
    let TGE20ContractTransactionResponse = TGE20Contract.deployTransaction;                   // Getting Transaction Response of deployment transaction
    let TGE20ContractTransactionRecipient = await TGE20ContractTransactionResponse.wait();    // Waiting until the contract is deployed
